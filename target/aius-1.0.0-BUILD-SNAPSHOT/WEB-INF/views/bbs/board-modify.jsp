						...
						<form method="post" action="/bWriteProcess">
							...
							<c:if test="${is_lock eq 'Y' }">
								<div class="form-group">
									<input type="checkbox" id="is_lock" name="is_lock"
										checked="checked" /> <label for="is_lock"><font
										size="2.6em">비밀로 하기</font></label><br> <input type="text" id="title"
										name="title" placeholder="제목을 입력해 주세요." value="${title}"
										...
										value="${article_password}" />
								</div>
							</c:if>
							<c:if test="${is_lock ne 'Y' }">
								<div class="form-group">
									<input type="checkbox" id="is_lock" name="is_lock" /> <label for="is_lock"><font
										size="2.6em">비밀로 하기</font></label><br> <input type="text"
										name="title" placeholder="제목을 입력해 주세요." value="${title}" id="title"
										maxlength="40" class="form-control"
										style="margin-bottom: 10px;"> <input type="password"
										id="at_pass" name="at_pass" maxlength="20"
										placeholder="  글 비밀번호 입력" class="form-control" />
							...
							<input type="hidden" name="at_type" value="${b}"> <input
								...
								value="0"> <input type="hidden" name="m" value="m">
