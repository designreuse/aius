				...
				<div class="row">
					<div class="col-lg-12"
						...
						<form method="post" action="/pWriteProcess"
							...
							<input type="hidden" name="at_writer" class="writer"
								value="${nickname}"> <input type="hidden" name="at_ref"
								value="${tmp.at_ref}"> <input type="hidden"
								name="at_re_lev" value="${tmp.at_re_lev}"> <input
								type="hidden" name="at_re_step" value="${tmp.at_re_step}">
							<input type="hidden" name="m" value="r"> <input
								type="hidden" name="at_id" value="${tmp.at_id}">
